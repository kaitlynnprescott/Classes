...
public class MyMaxHeap
{
	...
	public double MyMaxHeap(creditOffer[] arr, int n, double monthlyExpenses)
	{
		if (arr == null)
		{
			capacity = 5;
	...
	{
		double score1 = theHeap[i].cbr - theHeap[i].fee - theHeap[i].apr;
		double score2 = theHeap[j].cbr - theHeap[j].fee - theHeap[j].apr;
		if (score1 > score2)
		{
			return 1;
		}
