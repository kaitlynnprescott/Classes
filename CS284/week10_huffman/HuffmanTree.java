...
public class HuffmanTree implements Serializable
{
    ...
    {
    	HuffmanTree ourTree = new HuffmanTree();
    	HuffData[] ourSymbols = {new HuffData(3, 's'), new HuffData(2, 'e'), new HuffData(1, 'a'), new HuffData(1, h), new HuffData(2, l), new HuffData(1, ' ')};
    	ourTree.buildTree(ourSymbols);
    }
}
