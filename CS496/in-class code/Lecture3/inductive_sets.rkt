...
;; 2. the PL viewpoint (inductive data types)
;;
...
;;
;; <BTree> and <Nat> are non terminals. leaf, "(", ")" ",", node are terminals
;;
;;   node(leaf(s(0)), leaf(s(s(0)))) \in <BTree>
;;
...
;; btree -> num
(define (sumBT t)
  (cases btree t ;; takes name of type, then the instance
    (leaf (n) n) ;; case 1 (base case)
    (node (l r) (+ (sumBT l) (sumBT r))))) ;; case 2 (inductive case)
