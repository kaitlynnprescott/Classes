  ...
  (define (append-env env1 env2)
    (cases environment env1
      ...
      (extend-env (id val env)
                  (extend-env id val (append-env env env2)))
      (extend-env-recursively (id bvar body env)
                  (extend-env-recursively id bvar body (append-env env env2)))
      (extend-env-with-module (name val env)
                  (extend-env-with-module name val (append-env env env2)))
      ))
