(module interp (lib "eopl.ss" "eopl")
  ...
  ;; top-level-extend-env-with-module (for open)
  (define (top-level-extend-env-with-module m-name env)
    ;; uses lookup-module-name-in-env and append-env
  ...
  (define value-of
    (lambda (exp env)
      ...
      (cases expression exp
        ...
        (open-exp (id body)
                  (value-of body
                            (top-level-extend-env-with-module id env)))
        )))
